      ...
      <nav className="bg-white border-b border-sky-100 sticky top-0 z-50">
        <div className="max-w-5xl mx-auto px-5 py-4 flex items-center justify-between">
          ...
          <div className="hidden md:flex gap-5 text-sm text-gray-600">
            <button onClick={() => navigate("/laundry-service-narnaul")} className="hover:text-sky-500">Laundry</button>
      ...
      <footer className="bg-gray-900 text-gray-400 py-8 px-5 text-center text-sm">
        <div className="max-w-5xl mx-auto space-y-3">
          <div className="flex flex-wrap justify-center gap-4">
            <button onClick={() => navigate("/laundry-service-narnaul")} className="hover:text-white">Laundry Service</button>
            <button onClick={() => navigate("/laundry-near-me-narnaul")} className="hover:text-white">Near Me</button>
